...
/** Boxicons Regular `bx-server` — operational backbone / systems. */
export function BoxiconServer({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill="currentColor" d="M17 6h2v2h-2zm-3 0h2v2h-2zm3 10h2v2h-2zm-3 0h2v2h-2z" />
    </svg>
  );
}

/** Boxicons Regular `bx-layer` — stack / integration layer. */
export function BoxiconLayer({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** Boxicons Regular `bx-shield` — governance / protecting the platform. */
export function BoxiconShield({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** Boxicons Regular `bx-expand` — scaling / growing footprint. */
export function BoxiconExpand({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
